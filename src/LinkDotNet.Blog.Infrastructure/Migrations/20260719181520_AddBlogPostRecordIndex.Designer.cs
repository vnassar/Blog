...
namespace LinkDotNet.Blog.Infrastructure.Migrations
{
    ...
    [Migration("20260719181520_AddBlogPostRecordIndex")]
    partial class AddBlogPostRecordIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LinkDotNet.Blog.Domain.BlogPostRecord", b =>
                {
                    ...
                    b.HasIndex("BlogPostId", "DateClicked")
                        .HasDatabaseName("IX_BlogPostRecords_BlogPostId_DateClicked");

                    b.ToTable("BlogPostRecords");
                });

            modelBuilder.Entity("LinkDotNet.Blog.Domain.BlogPostTemplate", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .IsUnicode(false)
                    ...
                    b.ToTable("BlogPostTemplates");
                });

            modelBuilder.Entity("LinkDotNet.Blog.Domain.BlogPostVersion", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .IsUnicode(false)
